...
public class MailController {
    ...
    public ResponseEntity<BaseResponse<StibeeSubscribeResponse<SignUpValue>>> signup(@RequestBody UserSignUpDto userSignUpDto) {

        return BaseResponse.success(stibeeEmailService.addSubscriber(userSignUpDto));
    }

    @PostMapping("/mail/delete")
    public ResponseEntity<BaseResponse<StibeeSubscribeResponse<DeleteValue>>> delete(@RequestBody DeleteRequest request) {

...
public class UserMyPageController {
    ...
    @GetMapping("/profile")
    public ResponseEntity<BaseResponse<UserProfileDto>> provideUserInfo(@AuthenticationPrincipal CustomUserDetails user) {

        UserProfileDto userProfileDto = userMyPageService.provideUserInfo(user.getEmail());

...
public class AccountVerificationController {
    ...
    @Operation(summary = "트레이더략 실 전계좌 인증 이미지 등록 기능", description = "<a href='https://field-sting-eff.notion.site/fe8187f51c9c4a199622b932a1985458?pvs=4' target='_blank'>API 명세서</a>")
